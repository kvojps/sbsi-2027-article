...
| Extract passa a especializar Collector | `generalization_incompatible_natures` | um perdurante nao pode especializar um endurante | sim |

Reproduzir com `node tools/verification/controle-verificacao.js --modelo=rodada-2`.
