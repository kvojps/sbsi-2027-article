...
Quem mede é o verificador complementar, `scripts/ontouml/verificador-ufo-extra.js`, com cinco regras
...
# rodada 1 (ticket 04)
node scripts/ontouml/gerar-rodada-1.js                          # modelo, verificação e OWL
node scripts/ontouml/controle-verificacao.js --modelo=rodada-1  # controle sobre o revisado
...
python scripts/rodar_oops.py                 # OOPS! sobre o baseline (precisa de rede)
