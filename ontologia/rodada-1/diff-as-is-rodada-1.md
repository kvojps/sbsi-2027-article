...
Derivado dos dois modelos a cada execucao de `scripts/ontouml/diff-modelos.js`. E a materia-prima dos pares antes/depois; a leitura ontologica de cada um esta em `../correcoes-rodada-1.md`.
