 ...
 *
 * Uso: `node scripts/ontouml/controle-verificacao.js [--modelo=as-is|rodada-1] [saida]`
...
const MODELOS = {
  'as-is': {
    ...
    saida: path.join(RAIZ, 'ontologia', 'baseline', 'controle-verificacao.md'),
  ...
  'rodada-1': {
    ...
    saida: path.join(RAIZ, 'ontologia', 'rodada-1', 'controle-verificacao.md'),
...
function principal() {
  ...
  linhas.push('');
  linhas.push(
    `Reproduzir com \`node scripts/ontouml/controle-verificacao.js --modelo=${escolha}\`.`,
  );
  linhas.push('');
