 ...
 * ontologico explicito, em `ontologia/correcoes-rodada-1.md`.
 *
 * Uso: `node scripts/ontouml/verificador-ufo-extra.js [diretorio-de-saida]`
 */
...
function relatorioEmMarkdown(antes, depois) {
  ...
  const linhas = [
    ...
    'As cinco regras abaixo operacionalizam restricoes da UFO que as 24 do plugin OntoUML ' +
      ...
      '`scripts/ontouml/verificador-ufo-extra.js`.',
    '',
    '## Diferenca medida',
    '',
