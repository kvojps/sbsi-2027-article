 ...
 * modo que `ontologia/correcoes-rodada-1.md` possa argumentar sobre uma
 * tabela que nao pode estar errada sobre os fatos.
 *
 * Uso: `node scripts/ontouml/diff-modelos.js [arquivo-de-saida]`
 */
...
function principal() {
  ...
  const linhas = [
    ...
    '',
    'Derivado dos dois modelos a cada execucao de `scripts/ontouml/diff-modelos.js`. E a ' +
