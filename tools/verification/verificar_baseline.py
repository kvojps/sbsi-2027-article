...
Uso: python tools/verification/verificar_baseline.py [diretorio-ontologia]
...
fonte para `tools/model/ontompo-as-is.js`. A duplicacao e o teste: se as
...
# --------------------------------------------------------------------------
# Segunda leitura dos diagramas. NAO importar de tools/model/: o valor
